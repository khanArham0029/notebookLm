...
const EmptyDashboard = () => {
  ...
  return <div className="text-center py-16">
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">InsightsLM is an AI-powered research and writing assistant that works with available documents</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          ...
          <p className="text-gray-600">Access research papers, reports, and documents</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          ...
          <p className="text-gray-600">Access web pages and online articles</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          ...
          <p className="text-gray-600">Access text-based research materials</p>
        </div>
      </div>
